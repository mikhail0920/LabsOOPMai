...
(README некорректно отображается на тёмном фоне из-за вставленных формул)
...
## Тесты
Для проверки корректности использован фреймворк **Google Test**. Он позволяет писать структурированные юнит-тесты, запускать их пакетно и получать удобный вывод о результатах.  
